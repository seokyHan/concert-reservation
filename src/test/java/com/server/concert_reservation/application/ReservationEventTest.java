...
public class ReservationEventTest {
    ...
    @DisplayName("좌석 예약에 성공한다.(EventListener) - outbox 초기 INIT 상태에서 예약 성공시 PUBLISHED 상태로 변경")
    @Test
    void reservationSeatEventTest() throws InterruptedException {
        //given
        ...
        //then
        assertEquals(reservationOutbox.getKafkaMessageId(), "1");
        assertEquals(reservationOutbox.getStatus(), OutboxStatus.PUBLISHED);
    }
