package com.server.concert_reservation.interfaces.web.support.aspect.aop;
...
public class DistributedLockAspect {
    ...
    @Around("@annotation(com.server.concert_reservation.interfaces.web.support.aspect.aop.annotation.DistributedLock)")
